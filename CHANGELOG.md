...
- Move durable subagent configuration to `$PI_CODING_AGENT_DIR/herdr-agents/config.json`; package-root `config.json` is ignored. This requires a major version bump when released.
