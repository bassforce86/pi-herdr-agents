...
- Hardened explicit cleanup with machine-wide process checks, symlink-ancestor support, ignored-file disclosure, failed-commit index restoration, bounded command timeouts, and accurate preservation/removal reporting.
